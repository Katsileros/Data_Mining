...
int main(int argc, char **argv) {
  ...
  err = clEnqueueWriteBuffer(queue, d_a, CL_TRUE, 0, size, hostInput1, 0, NULL, NULL);
  err = clEnqueueWriteBuffer(queue, d_b, CL_TRUE, 0, size, hostInput2, 0, NULL, NULL);

  wbTime_stop(GPU, "Copying input memory to the GPU.");

  //@@ Initialize the grid and block dimensions here

  wbTime_start(Compute, "Execute the kernel");
  ...
  wbTime_stop(Compute, "Execute the kernel");
